...
export default function WorkspaceSettingsPage() {
  ...
  // --- 1. FORM SYNC (DURING RENDER) ---
  // This replaces the useEffect for setForm to avoid cascading renders[cite: 2]
  const [lastSyncedId, setLastSyncedId] = useState(null);
  if (currentWorkspace && currentWorkspace.id !== lastSyncedId) {
    setLastSyncedId(currentWorkspace.id);
    setForm({
