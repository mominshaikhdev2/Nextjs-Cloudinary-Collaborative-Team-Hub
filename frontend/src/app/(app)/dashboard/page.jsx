      ...
      <div>
        ...
        {isLoading ? (
          ...
          <div className="card p-12 text-center">
            <div className="w-14 h-14 rounded-2xl bg-zinc-800 mx-auto flex items-center justify-center text-2xl mb-4">
              ◈
            </div>
            ...
            <Link href="/workspaces/new" className="btn-primary inline-flex">
              Create workspace
            </Link>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="flex items-start justify-between mb-3">
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: `0 0 20px ${ws.accentColor}40`,
                    }}
                  >
            ...
            >
              <div className="w-10 h-10 rounded-xl border-2 border-dashed border-current flex items-center justify-center text-xl">
                +
              </div>
